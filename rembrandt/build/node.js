...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _imageComparator = __webpack_require__(8);
	  ...
	  _createClass(Rembrandt, [{
	    ...
	    value: function _validateOptions() {
	      ...
	      var _options = this._options,
	          thresholdType = _options.thresholdType,
	    ...
	    value: function _loadImage(image) {
	      return new _promise2.default(function (resolve, reject) {
	        ...
	        _fs2.default.readFile(image, function (err, buf) {
	          if (err) return reject(err);
	          resolve(_image2.default.fromBuffer(image));
	        });
	      });
	    }
	  }], [{
	...
	Rembrandt.version = __webpack_require__(10).version;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _compositionImage = __webpack_require__(9);
	...
	var ImageComparator = function () {
	  ...
	  _createClass(ImageComparator, [{
	    ...
	    value: function _comparePosition(x, y) {
	      var _options = this._options,
	          maxDelta = _options.maxDelta,
	          maxOffset = _options.maxOffset;
	  ...
	  _createClass(CompositionImage, [{
	    ...
	    value: function render() {
	      ...
	      return new _promise2.default(function (resolve, reject) {
	        ...
	        resolve(_this2._canvas.toBuffer());
	      });
	    }
	  }]);
